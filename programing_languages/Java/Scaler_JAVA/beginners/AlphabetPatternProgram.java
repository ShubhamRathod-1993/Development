...
public class AlphabetPatternProgram {
    private static void prob1(int  problemNo){
        ...
        System.out.println("Pattern name : "+ "Alphabet pyramid pattern");
        int size = 5;
    ...
    private static void prob2(int  problemNo){
        System.out.println("Problem No : " + problemNo);
        System.out.println("Pattern name : "+ "Reverse alphabet pyramid pattern");
        int size = 5;
        System.out.println("Size of pattern : " + size);
    ...
    private static void prob3(int  problemNo){
        System.out.println("Problem No : " + problemNo);
        System.out.println("Pattern name : "+ "Hollow alphabet pyramid pattern");
        int size = 5;
        System.out.println("Size of pattern : " + size);
    ...
    private static void prob4(int  problemNo){
        System.out.println("Problem No : " + problemNo);
        System.out.println("Pattern name : "+ "Alphabet diamond pattern");
        int size = 5;
        System.out.println("Size of pattern : " + size);
    ...
    private static void prob5(int  problemNo){
        System.out.println("Problem No : " + problemNo);
        System.out.println("Pattern name : "+ "Hollow alphabet diamond pattern");
        int size = 5;
        System.out.println("Size of pattern : " + size);

        int alpha=65, num=0;
        // upside hollow diamond
        for(int i=1; i <=size; i++){
            // printing  spaces
            for(int j=size; j> i; j-- ){
                System.out.print(" ");
        ...
        for(int i=1; i < size;i++){
            ...
            // set the  number to 0  after each row is printed
            num=0;
            System.out.println();
        }
    }
